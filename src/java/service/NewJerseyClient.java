...
public class NewJerseyClient {
    ...
    private static final String BASE_URI = "https://localhost:8080/playermanager/api";
    ...
    public NewJerseyClient() {
        ...
        webResource = client.resource(BASE_URI).path("team");
    }
    ...
    public <T> T findAllPlayers_XML(Class<T> responseType, String id) throws UniformInterfaceException {
        WebResource resource = webResource;
        resource = resource.path(java.text.MessageFormat.format("{0}/players", new Object[]{id}));
        return resource.accept(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }

    public <T> T findAllPlayers_JSON(Class<T> responseType, String id) throws UniformInterfaceException {
        WebResource resource = webResource;
        resource = resource.path(java.text.MessageFormat.format("{0}/players", new Object[]{id}));
